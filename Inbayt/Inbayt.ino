...
void setup() {
  ...
  pinMode(EswAnt, OUTPUT);// XIAO C6 quitar para XIAO S3
  pinMode(EAnt, OUTPUT);// XIAO C6 quitar para XIAO S3
  ...
  digitalWrite(EswAnt, LOW);// XIAO C6 quitar para XIAO S3
  digitalWrite(EAnt, HIGH);// XIAO C6 quitar para XIAO S3
...
void sendJsonData() {
  ...
  doc["device"] = THINGNAME; // Identificación del dispositivo
