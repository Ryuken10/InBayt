...
#define AWS_IOT_PUBLISH_TOPIC  "inbayt-things/INBAYT-MHAS5NR0-9VIP-Z2/status"
#define AWS_IOT_SUBSCRIBE_TOPIC "inbayt-board/INBAYT-MHAS5NR0-9VIP-Z2/command"
#define Relay D8
...
void sendJsonData() {
  ...
  doc["device"] = "INBAYT-MHAS5NR0-9VIP-Z2"; // Identificación del dispositivo
